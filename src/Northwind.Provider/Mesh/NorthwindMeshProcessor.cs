...
{
    public class Northwind_Command_MeshProcessor : BaseMeshProcessor
    {
        public Northwind_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          NorthwindConstants.ProviderId;
