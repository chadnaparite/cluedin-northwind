...
{
    public class DataIngestion : IClassFixture<NorthwindTestFixture>
    {
        private readonly NorthwindTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(NorthwindTestFixture fixture, ITestOutputHelper output)
        {
